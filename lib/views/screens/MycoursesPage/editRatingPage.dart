...
class EditRatingPage extends StatelessWidget {
  EditRatingPage({super.key});
  final RatingController controller = Get.find<RatingController>();

  @override
  Widget build(BuildContext context) {
    controller.ratingNum =
        controller.userRating[0]['rating']?.toDouble() ?? 0.0;
    controller.review.text = controller.userRating[0]['review'] ?? '';
            ...
            children: [
              ...
              Center(
                child: RatingBar.builder(
                  ...
                  initialRating: controller.ratingNum,
                  minRating: 0,
