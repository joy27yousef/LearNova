...
class TrandingCourses extends StatelessWidget {
  final int num;
  ...
  final HomepagecontrollerIMP controller = Get.find();
                    ...
                    child: Center(
                      child: Row(
                        children: [
                          ...
                          Text(
                            '${controller.treanding[i]['ratings_avg_rating'].toStringAsFixed(1)} (${controller.treanding[i]['ratings_count']})',
                            style: Theme.of(context)
                                .textTheme
                                .titleLarge!
